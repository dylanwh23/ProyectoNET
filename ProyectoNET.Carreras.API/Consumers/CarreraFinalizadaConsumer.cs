...
public class CarreraFinalizadaConsumer : IConsumer<CarreraFinalizadaEvent>
{
    ...
    public async Task Consume(ConsumeContext<ProyectoNET.Shared.EventosRabbit.CarreraFinalizadaEvent> context)
    {
